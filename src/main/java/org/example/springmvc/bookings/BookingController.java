...
public class BookingController {
    ...
    public String update(@PathVariable UUID id,
        ...
        try {
            ...
            return "redirect:/bookings/" + id + "/update";
        }
